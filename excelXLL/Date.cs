...
namespace excelXLL
{
    ...
    public partial class DateInfo
    {
        ...
        //}
        #endregion
        public DateInfo(DateTime dt, bool NoChinaCalendar = true)
        {
            ...
            TimeSpan ts = _date - excelXLL.DateInfo.MinDay;//计算两天的基本差距
            offset = ts.Days;
        ...
        public DateInfo(int cy, int cm, int cd, bool leapMonthFlag)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public DateInfo PervDay()
        {
            DateTime pervDay = _date.AddDays(-1);
            return new DateInfo(pervDay);
        }
        #endregion
